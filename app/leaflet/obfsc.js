...
var map = L.map('map', {
  ...
  var trigo = L.geoJSON(cultivosFina, {
    style: cultivosStyle,
    filter: function filtro(feature) {
      if (feature.properties.Cultivo === 'Trigo') {
        return true
      }
      else { return false }
    },
  ...
  var maiz = L.geoJSON(cultivosGruesa, {
    style: cultivosStyle,
    filter: function filtro(feature) {
      if (feature.properties.Cultivo === 'Maíz') {
        return true
      }
      else { return false }
    },
  ...
  var soja1ra = L.geoJSON(cultivosGruesa, {
    style: cultivosStyle,
    filter: function filtro(feature) {
      if (feature.properties.Cultivo === 'Soja 1ra.') {
        return true
      }
      else { return false }
    },
  ...
  var soja2da = L.geoJSON(cultivosGruesa, {
    style: cultivosStyle,
    filter: function filtro(feature) {
      if (feature.properties.Cultivo === 'Soja 2da.') {
        return true
      }
      else { return false }
    },
  ...
  */
  ...
  controlBarGruesa.setContent('<div class=""><canvas id="grafico-cgAzul"></canvas><hr><canvas id="grafico-cgTandil"></canvas></div>');
  ...
  controlBarFina.hide();
  controlBarFina.setContent('<div class=""><canvas id="grafico-cfAzul"></canvas><hr><canvas id="grafico-cfTandil"></canvas></div>');
  ...
  var btnGruesa = L.easyButton({
    states: [{
      ...
      icon: '<i class="fa fa-pie-chart" aria-hidden="true"> CAMPAÑA GRUESA 2022/23</i>',// and define its properties
    ...
    },
    {
      ...
      icon: '<i class="fa fa-arrow-left" aria-hidden="true" style="color:green"> CAMPAÑA GRUESA 2022/23</i>',// and define its properties
      //title: 'Gráficos',      // like its title
      onClick: function (btn) {       // and its callback
        //window.open('https://forms.gle/zX1bi6cXG82pkY178')
        controlBarGruesa.toggle();
  ...
  var btnFina = L.easyButton({
    states: [{
      stateName: 'Abrir',        // name the state
      //icon: '<img src="./img/chart.png">',// and define its properties
      icon: '<i class="fa fa-pie-chart" aria-hidden="true"> CAMPAÑA FINA 2022/23</i>',// and define its properties
      //title: 'Gráficos',      // like its title
      onClick: function (btn) {       // and its callback
        //window.open('https://forms.gle/zX1bi6cXG82pkY178')
    ...
    },
    {
      stateName: 'Cerrar',        // name the state
      //icon: '<img src="./img/chart-active2.png">',// and define its properties
      icon: '<i class="fa fa-arrow-left" aria-hidden="true" style="color:green"> CAMPAÑA FINA 2022/23</i>',// and define its properties
      //title: 'Gráficos',      // like its title
      onClick: function (btn) {       // and its callback
        //window.open('https://forms.gle/zX1bi6cXG82pkY178')
        controlBarFina.toggle();
